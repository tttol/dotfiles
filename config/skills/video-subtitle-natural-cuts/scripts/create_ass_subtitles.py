...
def build_ass(segments, width, height, font_size):
    style = f'Style: Default,Arial,{font_size},&H00FFFFFF,&H00FFFFFF,&H00000000,&H99000000,-1,0,0,0,100,100,0,0,1,5,1,2,80,80,150,1'
...
def main():
    ...
    args.output_ass.write_text(build_ass(segments, args.width, args.height, args.font_size))
