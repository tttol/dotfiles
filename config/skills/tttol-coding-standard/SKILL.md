...
### 8.2.6. No Logic in Tests

Strictly prohibit the use of `if` statements within test code. Test logic should be linear and deterministic; we do not write tests for the test code itself, so branching must be avoided to ensure test reliability.
