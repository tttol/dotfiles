----------------------------------------------------------------------------------
--- Copied from https://github.com/neovim/nvim-lspconfig/blob/master/lsp/jdtls.lua
----------------------------------------------------------------------------------
...
return {
  cmd = {
    ...
    -- get_jdtls_jvm_args(),
    '--jvm-arg=-javaagent:/Users/tttol/.local/share/nvim/mason/packages/jdtls/lombok.jar',
  },
  filetypes = { 'java' },
  root_markers = {
